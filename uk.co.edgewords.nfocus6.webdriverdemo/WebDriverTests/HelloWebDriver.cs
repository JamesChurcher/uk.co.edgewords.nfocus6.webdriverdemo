...
namespace uk.co.edgewords.nfocus6.webdriverdemo.WebDriverTests
{
    ...
    {
        [Test] //Annotation tells NUnit the following method is a test
        public void FirstTest()
        {
            ...
            screenshot.SaveAsFile(@"C:\Users\JamesChurcher\OneDrive - nFocus Limited\Pictures\Screenshots\fullpage.png");

            //Take a screenshot of a web element
            IWebElement formElm = driver.FindElement(By.Id("Login"));
            //var ssElm = formElm as ITakesScreenshot;
            var ssElm = (ITakesScreenshot)formElm;
            Screenshot screenshotElm = ssElm.GetScreenshot();
            screenshotElm.SaveAsFile(@"C:\Users\JamesChurcher\OneDrive - nFocus Limited\Pictures\Screenshots\form.png");
            ...
            try
            {
                ...
                Assert.That(bodyText, Does.Contain("User is not logged in").IgnoreCase, "Already logged in? Continue rest of test anyway...");
            }
            ...
            //Assert.That(1.0, Is.EqualTo(1.1).Within(10).Percent); //Actual value can deviate from Expected by 10% of Actual
            ...
            HelperLib myHelper = new HelperLib(driver); //Instantiate HelperLib class and pass the driver to the object
        ...
        [Test] //Another test - [SetUp] will run before to provide a browser, [TearDown] will run after to clean up.
        public void DragDropDemo()
        {
            ...
            //HelperLib myHelper = new HelperLib(driver); //Instantiate HelperLib class and pass the driver to the object
            //myHelper.WaitForElement(By.LinkText("#slider > a"), 7);
